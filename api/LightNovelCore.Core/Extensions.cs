...
{
	/// <summary>
	/// The default start of the week to use
	/// </summary>
	public static DayOfWeek StartOfTheWeek
	{
		get => DateTimeExtensions.StartOfTheWeek;
		set => DateTimeExtensions.StartOfTheWeek = value;
	}
	...
	public static DateOnly StartOfWeek(this DateOnly date, DayOfWeek? startOfWeek = null)
	{
	...
	public static DateOnly EndOfWeek(this DateOnly date, DayOfWeek? startOfWeek = null)
	{
